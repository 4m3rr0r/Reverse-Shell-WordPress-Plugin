...
1. Download the plugin file <a href="https://github.com/4m3rr0r/Reverse-Shell-WordPress-Plugin/releases/download/v1.4.0/reverse-shell.v1.4.0.zip" download="reverse-shell.zip">(`reverse-shell.zip`).</a>
